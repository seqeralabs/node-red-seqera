...
3. [**Auto-resume on workflow failure**](05-auto-resume-on-failure.md) - Automatically resume failed workflows to recover from transient errors
...
5. [**Studio on run fail + Slack webhook**](03-studio-slack-webhook.md) - Create a debugging Studio and send Slack notifications on workflow failure
